            ...
            <div id={"uploadImage_container"} className={'col-7 row justify-content-center border  '}>
                <form onSubmit={uploadFile}>
                    <div className={'col-12 mt-3 row justify-content-center  '}>
                        <label style={{borderBottom: "1px solid gray", marginBottom: "10px"}}
                               className={'ms-3 col-2  text-center'} for={'files'}>
                            Vybrat soubory
                            <input id={'files'} style={{display: "none"}} type="file" multiple
                                   onChange={onUploadChanged} required/>
                        </label>
