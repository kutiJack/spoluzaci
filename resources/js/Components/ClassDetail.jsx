...
// server vrátil jména uživatelů, kteří jsou zapsání v této třídě...
    ...
    const enrollToClass = ()=>{
        ...
        const  res =  axios.post(url + "/enrollToClass", {class_id: class_id, user_id:user_id}, {withCredentials: true}).then(
            (response)=>
            {
    ...
    function goToGallery()
    {
        ...
        navigate('/gallery', {state:{school_id: school_id, class_id: class_id, class_name:class_name, year:year, school_name:school_name }} )
    ...
    function onSubmit(data){
      ...
      const sender=user_name;
        ...
        const res =  axios.post(url + '/addMessage', {class_id: class_id, sender: sender, content:content, currentdate:datetime, isChild:false}, {withCredentials: true}).then(
...
// Pokud už je třída uložená v Moje třídy, nezobrazí se tlačítko pro přidání třídy...
    ...
    function addToMyClasses()
    {
        ...
        const  res =  axios.post(url + "/addToMyClasses", {class_id: class_id, user_name:user_name, school_id:school_id }).then((response)=>{
            ...
            <div className='col-12 row justify-content-center' id='class_detail_container '>
                ...
                <div className="col-11 row justify-content-center" id="class_detail_header_container"  >
                    ...
                    <div className='justify-content-center col-10'  >
                        <div id="class_detail_header_year_class_div" className="col-12 row text-center justify-content-center"  >
                            {class_name}
                            <span
                                className="text-center" style={{marginTop: "12px", width: "55px", fontSize:"18px"}}>ročník
                    </span>
                            <span
                                className="text-center" style={{marginTop: "12px",width: "100px",fontSize: "18px"}}>{year}
                        </span>
                        ...
                        <div id="class_detail_header_schoolname_div" style={{fontSize: '22px'}}  className="col-12 text-center ">{school_name}</div>
                        ...
                        <div className='col-12 row justify-content-center' style={{height: '25px'}} >
                            ...
                            {auth.user !=null
                                ?
                                <div onClick={enrollToClass}  className=" col-2 text-center" id="class_detail_header_enroll_div">Zapsat se do třídy
                            </div>
                                :
                                null}
...

                            {
                                ...
                                checkmyclasses=="exists" ?
                                    ...
                                    <div id='class_detail_header_add_to_myclass_div' className='col-2 text-center'>
                ...
                {newMessageVisible ?
                    <div  className="col-8 row justify-content-center">
                        <form className="col-12 row justify-content-center" onSubmit={handleSubmit(onSubmit)} >
                            <textarea id="board_new_message_dialog" className="col-12" rows="3" cols="70"></textarea>
