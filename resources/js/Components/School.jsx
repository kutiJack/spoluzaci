...
// výběrem školy v listboxu získá id školy
        ...
        setSchoolData(prevState => {
            return {...prevState, school_id: school_id, fullname: e.target.value}
        })
    ...
    return (
        <>
            <div className="col-12 d-flex justify-content-center">
                <div className="row  mt-3 text-center align-items-center" style={{
                    width: "80%",
                    height: "70px",
            ...
            <div className="col-12 d-flex justify-content-center">
                <div className=" row mt-3 justify-content-center " style={{width: "80%"}}>
                    ...
                    <div id={"select_div"} className="col-12 row">
                        ...
                        <div className={"col-2"}>
                            <select className="col-12" size="19" onChange={getCities} name='districts' id='districts'
                                    style={{visibility: "hidden"}}/>
                        </div>

                        <div className={"col-2"}>
                            <select onChange={getSchools} className={"col-12"} size="19" name='cities' id='cities'
                                   style={{visibility: "hidden", overflow: "visible !important"}}/>
                        </div>

                        <div className={"col-5"} style={{borderRight: "1px solid green"}}>
                            <select onChange={(e) => getSchoolDetail(e)} className={"col-12"} size="19" name='schools'
                                    id='schools' style={{visibility: "hidden", overflow: "visible !important"}}/>
                        </div>
                    </div>
                </div>
            </div>
